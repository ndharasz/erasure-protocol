...
import "./SimpleGriefingWithFees.sol";


/// @title SimpleGriefingWithFees_Factory
...
contract SimpleGriefingWithFees_Factory is Factory {

    constructor(address instanceRegistry, address templateContract) public {
        SimpleGriefingWithFees template;
        // set instance type
